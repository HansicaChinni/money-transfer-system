...
class AdminControllerTest {
    ...
    void allAccountsNoNames_ShouldReturnListOfAccounts() throws Exception {
        ...
        List<AdminAccountView> mockAccounts = Arrays.asList(
                new AdminAccountView(1L, "ACC-001", new BigDecimal("1000.00"), "ACTIVE", now),
                new AdminAccountView(2L, "ACC-002", new BigDecimal("2500.50"), "ACTIVE", now),
                new AdminAccountView(3L, "ACC-003", new BigDecimal("500.75"), "LOCKED", now)
        );
    ...
    void allAccountsNoNames_ShouldHandleMultipleAccountStatuses() throws Exception {
        ...
        List<AdminAccountView> mockAccounts = Arrays.asList(
                new AdminAccountView(1L, "ACC-001", new BigDecimal("1000.00"), "ACTIVE", now),
                new AdminAccountView(2L, "ACC-002", new BigDecimal("2500.50"), "LOCKED", now),
                new AdminAccountView(3L, "ACC-003", new BigDecimal("0.00"), "CLOSED", now)
        );
